...
def _make_client_factory(
    ...
    *,
    ...
    The ``Client`` built here (fastmcp's ``Client.call_tool``) injects the
    broker's own then-current span context into the outbound MCP request's
    ``_meta`` (SEP-414), which is broker-generated by
